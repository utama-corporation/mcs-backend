...
async function renderRangkumanSelisihStockOpname(doc, noSO) {
  ...
  doc
    .fontSize(13)
    .font("Helvetica-Bold")
    .text("I. Rangkuman Selisih Stock Opname", leftMargin, doc.y, {
      align: "left",
    });
  doc.moveDown(0.8);
  ...
  doc.text(formatQty(totalSistem), colX[3] + 3, y + 5, {
    width: colWidths[3] - 6,
    align: "center",
  });
  doc.text(formatQty(totalFisik), colX[4] + 3, y + 5, {
    width: colWidths[4] - 6,
    align: "center",
  });
  doc.text(totalSelisihDisplay, colX[5] + 3, y + 5, {
    width: colWidths[5] - 6,
    align: "center",
  });
