...
const { generateStockOpnameAssetPdf } = require('../../services/pdf/report-so-asset/generate-stock-opname-asset-pdf');
...
router.get('/report/:noso/pdf', async (req, res) => {
  try {
    ...
    await generateStockOpnameAssetPdf(res, { noSO, tanggal, lockedDate, perusahaan, lokasi });
  } catch (error) {
